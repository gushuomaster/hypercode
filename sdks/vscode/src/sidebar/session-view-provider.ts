...
export class SessionViewProvider implements vscode.WebviewViewProvider, vscode.Disposable {
  ...
  private onMessage(message: WebviewMessage) {
    ...
    if (message?.type === "navigateSession") {
      void vscode.commands.executeCommand("hypercode.openSessionById", this.currentRef, message.sessionID)
      return
    }

    if (message?.type === "newSession") {
      void vscode.commands.executeCommand("hypercode.newSessionAndOpen", this.currentRef)
      return
    }
