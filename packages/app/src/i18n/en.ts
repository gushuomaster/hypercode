...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by HyperCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in HyperCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "HyperCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in HyperCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in HyperCode.",
  ...
  "model.free.description.museSpark13": "Multimodal all-rounder for complex analysis, long documents, and tool calls",
  "model.free.description.mimoV25": "Balanced reasoning and multimodal understanding for code, images, and video",
  "model.free.description.kimiK25": "General model strong in visual, video, and code analysis",
  "model.free.description.mimoV2Omni": "Omnimodal model for text, images, audio, and PDFs",
  "model.free.description.qwen36Plus": "General multimodal model for visual and video analysis",
  "model.free.description.minimaxM3": "Reasoning-focused model with image and video understanding",
  "model.free.description.glm5": "Strong in complex reasoning, code, and tool calls",
  "model.free.description.deepseekV4Flash": "Fast reasoning and code model for everyday development",
  "model.free.description.nemotron3Ultra": "High-capability reasoning model for complex tasks",
  "model.free.description.museSpark12": "General multimodal model with long context and tool calls",
  "model.free.description.xPreviewF": "Experimental model with image, video, and long-context support",
  "model.free.description.minimaxM25": "General reasoning and code model",
  "model.free.description.mimoV2Pro": "Focused on deep reasoning and complex analysis",
  "model.free.description.glm47": "General reasoning, code, and tool-calling model",
  "model.free.description.nemotron3Super": "Focused on reasoning and agentic tasks",
  "model.free.description.nemotron35Lightning": "Low-latency reasoning model for frequent use",
  "model.free.description.minimaxM21": "General code and reasoning model",
  "model.free.description.longcat20": "General text reasoning model",
  "model.free.description.hy3": "Model for code and agentic tasks",
  "model.free.description.hy3Preview": "Hy3 preview for code and tool calls",
  "model.free.description.northMiniCode": "Lightweight code model for fast programming help",
  "model.free.description.grokCode": "Fast model for generating and editing code",
  "model.free.description.ring26": "Lightweight reasoning model",
  "model.free.description.mimoV2Flash": "Fast general reasoning model",
  "model.free.description.trinityLargePreview": "Preview of a general-purpose large model",
  "model.free.description.bigPickle": "General agentic model for coding tasks",
  "model.free.description.ling30FlashFin": "Fast general reasoning model",
  "model.free.description.ling30Flash": "Fast general reasoning model",
  "model.free.description.ling26Flash": "Lightweight, fast reasoning model",
  "model.free.description.ling30Tiny": "Lightweight model for simple tasks",
  "model.free.description.lagunaS21": "General text model",
  "model.free.description.inputs": "Supports {{inputs}} input",
  "model.free.description.reasoningTools": "Supports reasoning and tool calls",
  "model.free.description.reasoning": "Supports reasoning",
  "model.free.description.tools": "Supports tool calls",
  "model.free.description.context": "{{context}} context",
  "model.free.description.general": "Free general-purpose model",
  ...
  "dialog.plugins.empty": "Plugins configured in hypercode.json or opencode.json",
  ...
  "dialog.server.description": "Switch which HyperCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "HyperCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking HyperCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking HyperCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating HyperCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating HyperCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update HyperCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update HyperCode",
  "wsl.onboarding.opencodeReadyIn": "HyperCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "HyperCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install HyperCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install HyperCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen HyperCode.",
  ...
  "toast.update.description": "A new version of HyperCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the HyperCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, HyperCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "HyperCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "HyperCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the HyperCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for HyperCode",
  ...
  "settings.general.row.appearance.description": "Customise how HyperCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether HyperCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how HyperCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when HyperCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of HyperCode.",
