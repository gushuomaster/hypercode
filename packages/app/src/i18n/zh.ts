...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 HyperCode Zen 或 API 密钥连接",
  ...
  "provider.connect.opencodeZen.line1": "HyperCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "model.tag.free": "免费",
  "model.tag.latest": "最新",
  "model.free.description.museSpark13": "综合多模态模型，适合复杂分析、长文档和工具调用",
  "model.free.description.mimoV25": "均衡推理与多模态理解，适合代码、图片和视频任务",
  "model.free.description.kimiK25": "擅长视觉、视频理解和代码分析的通用模型",
  "model.free.description.mimoV2Omni": "覆盖文本、图片、音频和 PDF 的全模态模型",
  "model.free.description.qwen36Plus": "通用多模态模型，适合视觉和视频分析",
  "model.free.description.minimaxM3": "强调推理能力并支持图片、视频理解",
  "model.free.description.glm5": "偏重复杂推理、代码和工具调用",
  "model.free.description.deepseekV4Flash": "快速推理和代码模型，适合日常开发任务",
  "model.free.description.nemotron3Ultra": "高强度推理模型，适合复杂任务",
  "model.free.description.museSpark12": "多模态通用模型，支持长上下文和工具调用",
  "model.free.description.xPreviewF": "支持图片、视频和长上下文的实验性模型",
  "model.free.description.minimaxM25": "通用推理和代码模型",
  "model.free.description.mimoV2Pro": "偏重深度推理和复杂分析",
  "model.free.description.glm47": "通用推理、代码和工具调用模型",
  "model.free.description.nemotron3Super": "偏重推理和智能体任务",
  "model.free.description.nemotron35Lightning": "低延迟推理模型，适合高频调用",
  "model.free.description.minimaxM21": "通用代码和推理模型",
  "model.free.description.longcat20": "通用文本推理模型",
  "model.free.description.hy3": "代码和智能体任务模型",
  "model.free.description.hy3Preview": "Hy3 预览版，适合代码和工具调用",
  "model.free.description.northMiniCode": "轻量代码模型，适合快速编程辅助",
  "model.free.description.grokCode": "快速代码生成和修改模型",
  "model.free.description.ring26": "轻量级推理模型",
  "model.free.description.mimoV2Flash": "快速通用推理模型",
  "model.free.description.trinityLargePreview": "通用大模型预览版",
  "model.free.description.bigPickle": "通用智能体模型，适合代码任务",
  "model.free.description.ling30FlashFin": "快速通用推理模型",
  "model.free.description.ling30Flash": "快速通用推理模型",
  "model.free.description.ling26Flash": "轻量快速推理模型",
  "model.free.description.ling30Tiny": "轻量模型，适合简单任务",
  "model.free.description.lagunaS21": "通用文本模型",
