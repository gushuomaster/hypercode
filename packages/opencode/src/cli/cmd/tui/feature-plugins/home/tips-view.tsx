...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent HyperCode from reading sensitive files",
  "Use {highlight}hypercode run{/highlight} for non-interactive scripting",
  "Use {highlight}hypercode --continue{/highlight} to resume the last session",
  "Use {highlight}hypercode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}hypercode serve{/highlight} for headless API access to HyperCode",
  "Use {highlight}hypercode run --attach{/highlight} to connect to a running server",
  "Run {highlight}hypercode upgrade{/highlight} to update to the latest version",
  "Run {highlight}hypercode auth list{/highlight} to see all configured providers",
  "Run {highlight}hypercode agent create{/highlight} for guided agent creation",
  "Use the configured GitHub trigger in issues or PRs to start AI actions",
  "Run {highlight}hypercode github install{/highlight} to set up the GitHub workflow",
  "Use your configured GitHub trigger on issues to auto-create PRs",
  ...
  "Run {highlight}hypercode debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with HyperCode Zen for curated, tested models",
