...
<html>
  <head>
    <title>HyperCode - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to HyperCode.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>HyperCode - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
