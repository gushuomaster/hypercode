...
const textKeys = {
  ...
  "skill.scope.project": "dialog.skill.scope.project",
  "skill.scope.global": "dialog.skill.scope.global",
  "skill.scope.builtin": "dialog.skill.scope.builtin",
  "skill.scope.external": "dialog.skill.scope.external",
