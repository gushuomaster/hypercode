    ...
    const warp = async (selection: WorkspaceSelection) => {
      const workspaceID = await (async () => {
        ...
        try {
          ...
          toast.show({
            title: t("dialog.sessionList.createWorkspaceFailed"),
      ...
      <DialogSessionDeleteFailed
        ...
        onDelete={async () => {
          ...
          if (result.error) {
            toast.show({
              variant: "error",
              title: t("dialog.sessionList.deleteWorkspaceFailed"),
  ...
  const options = createMemo(() => {
    ...
    const remaining = displayOrder
      ...
      .map((id) => {
        ...
        return buildOption(id, label === today ? t("dialog.sessionList.today") : label)
      })
      .filter((x) => x !== undefined)

    return [...pinned.map((id) => buildOption(id, t("dialog.sessionList.pinned"))).filter((x) => x !== undefined), ...remaining]
  })
      ...
      actions={[
        {
          ...
          title: t("dialog.sessionList.pinToggle"),
              ...
              try {
                ...
                if (result.error) {
                  if (session?.workspaceID) {
                    ...
                    toast.show({
                      variant: "error",
                      title: t("dialog.sessionList.deleteFailed"),
                      message: errorMessage(result.error),
                    })
                  }
                  setToDelete(undefined)
...
function quickSwitchRange(first: string, last: string) {
  ...
  return t("dialog.sessionList.quickSwitchRange", { first, last })
}
